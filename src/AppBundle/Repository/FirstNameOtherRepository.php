...
use AppBundle\Entity\FirstNameOther;

/**
 * FirstNameOtherRepository
 * This class was generated by the Doctrine ORM. Add your own custom
 * repository methods below.
 */
class FirstNameOtherRepository extends BaseRepository
{
    /**
    ...
    public function refresh()
    {
        ...
        // STEP1: クリアテーブル
        $em->getConnection()->exec("TRUNCATE TABLE first_name_other");
        // STEP2: データ取得して全件追加
        $characterBaseRepository = $em->getRepository('AppBundle:CharacterBase');
        $names = $characterBaseRepository->getFirstNames(array('gender' => 5));
        if (empty($names)) {
            return 0;
        }
        foreach ($names as $record) {
            $entity = new FirstNameOther();
