...
use AppBundle\Entity\MiddleName;

/**
 * MiddleNameRepository
 * This class was generated by the Doctrine ORM. Add your own custom
 * repository methods below.
 */
class MiddleNameRepository extends BaseRepository
{
    /**
    ...
    public function refresh()
    {
        ...
        // STEP1: クリアテーブル
        $em->getConnection()->exec("TRUNCATE TABLE middle_name");
        // STEP2: データ取得して全件追加
        $characterBaseRepository = $em->getRepository('AppBundle:CharacterBase');
        $names = $characterBaseRepository->getMiddleNames();
        if (empty($names)) {
            return 0;
        }
        foreach ($names as $record) {
            $entity = new MiddleName();
