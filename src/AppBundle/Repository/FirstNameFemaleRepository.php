...
use AppBundle\Entity\FirstNameFemale;

/**
 * FirstNameFemaleRepository
 * This class was generated by the Doctrine ORM. Add your own custom
 * repository methods below.
 */
class FirstNameFemaleRepository extends BaseRepository
{
    /**
    ...
    public function refresh()
    {
        ...
        // STEP1: クリアテーブル
        $em->getConnection()->exec("TRUNCATE TABLE first_name_female");
        // STEP2: データ取得して全件追加
        $characterBaseRepository = $em->getRepository('AppBundle:CharacterBase');
        $names = $characterBaseRepository->getFirstNames(array('gender' => 3));
        if (empty($names)) {
            return 0;
        }
        foreach ($names as $record) {
            $entity = new FirstNameFemale();
